...
population_colors <- readRDS(paste0(pca_path, "PCA_population_colors.Rds"))
legend_order <- readRDS(paste0(pca_path, "PCA_legend_order.Rds"))
legend_labels <- readRDS(paste0(pca_path, "PCA_legend_labels.Rds"))
label_count_case <- readRDS(paste0(pca_path, "PCA_label_count_case.Rds"))
label_count_control <- readRDS(paste0(pca_path, "PCA_label_count_control.Rds"))
